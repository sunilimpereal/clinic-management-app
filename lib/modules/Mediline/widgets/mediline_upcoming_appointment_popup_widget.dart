...
class _MedilineUpcomingAppointmentPopupWidgetState
  ...
  Widget body(BuildContext context, AppointmentDatum getAllAppointments) {
    return Padding(
              ...
              Stack(
                children: [
                  Container(
                      ...
                      child: appointmentDetail(getAllAppointments)),
                ],
              ),
              clinicDetail(getAllAppointments.appointment),
            ],
          ),
        ),
      ),
  ...
  Widget appointmentDetail(AppointmentDatum? appointmentsDetailsData) {
    ...
    if (appointmentsDetailsData != null) {
      appointmentDate = getSplitedDateAndTimeString(
          appointmentsDetailsData.appointment.appointmentDate.toString(), true);
      appointmentStartTime = getSplitedDateAndTimeString(
          appointmentsDetailsData.appointment.startTime.toString(), false);
      appointmentendTime = getSplitedDateAndTimeString(
          appointmentsDetailsData.appointment.endTime.toString(), false);
    }
            ...
            Row(
              ...
              children: [
                Expanded(
                  ...
                  child: ProfileImage(
                      scale: 0.2,
                      image: appointmentsDetailsData?.doctor?.userData.photo ??
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        appointmentsDetailsData?.doctor?.userData.name ??
                            "Dr. Aditi Sharma",
                      ...
                      Text(
                        appointmentsDetailsData
                                ?.doctor?.doctor.specialisationId ??
                            "Urologist",
                        style: TextStyle(
