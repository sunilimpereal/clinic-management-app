...
import 'package:clinic_app/modules/NewAppointment/widgets/check_availability_widget.dart';
import 'package:clinic_app/modules/online_consultation/widgets/start_consultation_alert.dart';
  ...
  Widget doctorDetail() {
    return Row(
      children: [
        CircleAvatar(
          radius: 24,
          backgroundImage: widget.availableDoctor.userData.photo == null
              ? const AssetImage(ImagesConstants.doctor)
              : Image.network(widget.availableDoctor.userData.photo!).image,
        ),
