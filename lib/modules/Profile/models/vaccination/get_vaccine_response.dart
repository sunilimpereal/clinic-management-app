...
class VaccinationsResponse {
  ...
  factory VaccinationsResponse.fromJson(Map<String, dynamic> json) => VaccinationsResponse(
        ...
        data: List<VaccineDatum>.from(json["data"].map((x) => VaccineDatum.fromJson(x))),
        error: json["error"],
      );
...
class VaccineDatum {
  ...
  factory VaccineDatum.fromJson(Map<String, dynamic> json) => VaccineDatum(
        id: json["id"],
