class GetSpecificPatientresponse {
  ...
  factory GetSpecificPatientresponse.fromJson(Map<String, dynamic> json) => GetSpecificPatientresponse(
...
class GetSpecificPatientDataById {
  ...
  GetSpecificPatientAllergydata? allergies;
  ...
  factory GetSpecificPatientDataById.fromJson(Map<String, dynamic> json) => GetSpecificPatientDataById(
        userData: UserData.fromJson(json["userData"]),
        patient: GetSpecificPatientinfoDataById.fromJson(json["patient"]),
        allergies: json["allergies"] == null ? null : GetSpecificPatientAllergydata.fromJson(json["allergies"]),
        // json["allergies"] != null
        //     ?
        //     //  List<GetSpecificPatientAllergydata>.from(json["allergies"]
        //     //     .map((x) =>
...
class GetSpecificPatientAllergydata {
  ...
  GetSpecificPatientAllergydata({this.id, this.patientId, this.medicineAllergies, this.foodAllergies, this.petAllergies, this.other = ""});
...
class GetSpecificPatientinfoDataById {
  ...
  GetSpecificPatientinfoDataById({this.id, this.gender, this.maritalStatus, this.createdAt, this.isArchived, this.updatedAt, this.userId});
