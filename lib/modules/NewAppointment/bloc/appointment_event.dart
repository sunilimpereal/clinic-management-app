...
class GetSpecialityEvent extends AppointmentEvent {
  const GetSpecialityEvent();
}
...
class ReinitalizeAppointmentEvent extends AppointmentEvent {
  const ReinitalizeAppointmentEvent();
