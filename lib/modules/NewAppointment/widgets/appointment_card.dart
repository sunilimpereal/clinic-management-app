...
class _AppointmentCardState extends State<AppointmentCard> {
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              clinicDetail(clinic: widget.availableDoctor.doctorClinic),
              appointmentDetail(clinic: widget.availableDoctor.doctorClinic),
            ],
          ),
        ),
      ),
  ...
  Widget clinicDetail({required DoctorClinic clinic}) {
    return ClipPath(
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "${DateFormat("EEE").format(widget.selectedDate)}, ${DateFormat("MMM").format(widget.selectedDate)} ${widget.selectedDate.day} | ${DateFormat("hh:mm a").format(widget.slot.startTime.toLocal())} -${DateFormat("hh:mm a").format(widget.slot.endTime.toLocal())} ",
                    style: TextStyle(
                      color: Colors.grey.shade700,
                    ),
                  )
  ...
  Widget appointmentDetail({required DoctorClinic clinic}) {
    return ClipPath(
