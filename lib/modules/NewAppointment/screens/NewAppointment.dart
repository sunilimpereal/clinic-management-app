...
class _NewAppointmentScreenState extends State<NewAppointmentScreen> {
  ...
  void initState() {
    ...
    BlocProvider.of<AppointmentBloc>(context)
        .add(const ReinitalizeAppointmentEvent());
    BlocProvider.of<AppointmentBloc>(context).add(const GetSpecialityEvent());
  }
      ...
      builder: (context, state) {
        ...
        return SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () {
              if (state.appointmentDate == null && state.isEmergency == false) {
                showPopup(
                    context: context,
