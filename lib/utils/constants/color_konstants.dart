...
// prescription ui
  ...
  // form field colors
  static Color hintTextColor = const Color.fromRGBO(120, 120, 120, 1);
  static Color labelTextColor = const Color(0xffA8B3C4);

  // link color
  static Color linkColor = const Color(0xff007BC7);

  // svg colors
  static Color drawerIconColor = const Color(0xff007bc7);
}
