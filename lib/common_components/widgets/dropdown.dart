                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          widget.selectedItem?.iconData != null
                              ? Icon(widget.selectedItem!.iconData)
                              : Container(),
                          SizedBox(
                            width:
                                widget.selectedItem?.iconData != null ? 0 : 0,
                          ),
                          Text(
...
class DropDownItem {
  ...
  final String? id;
  const DropDownItem({required this.name, this.iconData, this.id});
}
